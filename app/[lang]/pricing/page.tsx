...
export default async function Pricing({ params }: PricingProps) {
  ...
  const content = {
    ...
    ar: {
      title: 'الثمن واضح وبسيط',
      subtitle: 'اختار البــاقة اللي تناسب عملك وابدا معنا الحيط الرقمية',
      companyWebsite: 'موقع الشركة',
      restaurantWebsite: 'موقع ديال مطعم',
      ecommerce: 'متجر على الإنترنت',
      customApp: 'تطبيق خاص بيك',
      daysDelivery: 'التسليم في',
      days: 'يوم',
      drh: 'درهم',
    },
  };
