...
export default async function Showcase({ params }: ShowcaseProps) {
  ...
  const content = {
    ...
    ar: {
      title: 'الأعمال اللي بنيناها',
      subtitle: 'شوف المشاريع والأعمال اللي حققناها للشركات والمؤسسات المغربية',
      testimonials: 'آراء العملاء',
      cta: 'بغيت نبني موقع احترافي لعملك؟',
      ctaDesc: 'رانا هنا باش نساعدك تحقق أحلامك الرقمية. تواصل معنا اليوم!',
      ctaBtn: 'طلب موقعك الآن',
      ctaBtn2: 'تواصل على الواتس',
