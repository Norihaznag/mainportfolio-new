...
export default async function HowItWorks({ params }: HowItWorksProps) {
  ...
  const content = {
    ...
    ar: {
      title: 'عملية بسيطة وموثوق',
      subtitle: 'رانا ندازو شي واضح ومنظم باش نتر ليك أحسن نتيجة',
      step1: 'لقائنا بيك',
      step1Desc: 'نتحداو معاك علاش نفهمو اللي بغيت والاللي باغيا تهدر بموقعك.',
      step2: 'الديزاين والتخطيط',
      step2Desc: 'راني نرسمو ليك لقاعدة الموقع ونقول ليك فاش راني ريبيع للي.',
      step3: 'بناء الموقع',
      step3Desc: 'في هذ لمرحلة راني نسكرا للأكواد ونبني ليك موقعك بأحدث التقنيات.',
      step4: 'الإطلاق',
      step4Desc: 'راني نختبرو موقعك على كتر مبروجات وبعدا ما نطلقو ليك للعالم.',
      whatYouGet: 'لعطوك شنوه',
      features: ['موقع سريع وآمن', 'متوافق مع الهاتف بنسبة 100%', 'محسّن لمحركات البحث', 'دعم فني احترافي'],
    },
  };
