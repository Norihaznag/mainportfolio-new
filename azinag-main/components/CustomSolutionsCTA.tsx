  ...
  return (
    <div className="relative overflow-hidden border border-border-subtle rounded-3xl bg-white p-10 md:p-12">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse at center, rgba(29,78,216,1) 0%, transparent 70%)' }}
      />
      ...
      <div className="relative flex flex-col lg:flex-row lg:items-center gap-10">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              href="/services"
              className="inline-flex items-center gap-2 border border-border-subtle bg-white text-ink font-semibold rounded-lg px-6 py-3.5 text-[0.9375rem] hover:bg-surface-raised transition-colors"
            >
              View All Services →
            </Link>
          </div>
