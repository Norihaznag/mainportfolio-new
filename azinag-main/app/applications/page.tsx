  ...
  return (
    <main className="text-ink">
      ...
      <div className="text-center px-6 pt-14 pb-10">
        ...
        <p className="text-[1.0625rem] text-ink-muted max-w-[520px] mx-auto">
          Browse Azinag SaaS and desktop products by category, platform, and operations use case.
        </p>
      </div>
      ...
      <div className="px-6 pb-24 max-w-5xl mx-auto">
        ...
        {!loading && !isDefault && (
          filtered.length === 0
            ? <p className="text-center text-ink-muted text-sm py-24">No applications are available in this category yet.</p>
            : (
        ...
        {!loading && isDefault && apps.length > 0 && (
          <>
            ...
            <div className="rounded-2xl bg-ink text-canvas px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div>
                <p className="font-black text-xl mb-1">Need help choosing the right product?</p>
                <p className="text-sm opacity-60">Contact support for plan guidance, billing questions, and availability.</p>
              </div>
              <Link
                href="/contact"
